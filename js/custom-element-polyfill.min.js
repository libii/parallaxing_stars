...
(function () {
  ...
  (function (a) {
    ...
    var xa = /(url\()([^)]*)(\))/g,
      ...
      t = {
        ...
        j: function (a, b) {
          ...
          if (t.l) return (new URL(a, b)).href;
          d = t.F;
    ...
    g.prototype.A = function (a) {
      ...
      } else this.b++, this.a[d] = "pending", Z.load(d, function (a, c) {
        a = b.L(a, c || d);
        b.a[d] = a;
        b.b--;
        b.loadImports(a);
    ...
    g.prototype.L = function (a, b) {
      ...
      d.innerHTML = a;
      if (d.content) a = d.content, l(a);
      else
        for (a = document.createDocumentFragment(); d.firstChild;) a.appendChild(d.firstChild);
      if (d = a.querySelector("base")) b = t.j(d.getAttribute("href"), b), d.removeAttribute("href");
      var c = 0;
    ...
    var M = null;
    if (J) r(k(document, "link[rel=import]"), function (a) {
  ...
  F.prototype.a = function (a, b) {
    ...
    if (!ba(a)) throw new SyntaxError("The element name '" + a + "' is not valid.");
  ...
  function ha(a) {
    if (!1 !== a.h) {
      ...
      for (; 0 < b.length;) {
        ...
        e = f.localName;
        f = d.get(f.localName);
        for (var m = 0; m < f.length; m++) z(a.f, f[m]);
        (e = a.u.get(e)) && fa(e)
      }
    }
  }
  ...
  F.prototype.b = function (a) {
    if (!ba(a)) return Promise.reject(new SyntaxError("'" + a + "' is not a valid custom element name."));
    var b = this.u.get(a);
    if (b) return b.c;
    b = new ea;
    this.u.set(a, b);
  ...
  function Ja() {
    ...
    window.HTMLElement = function () {
      function b() {
        ...
        if (0 === e.length) return e = G.call(document, d.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = d, x(a, e), e;
        d = e.length - 1;
        var f = e[d];
        if (f === Ia) throw Error("The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.");
        e[d] = Ia;
  ...
  function U(a, b, c) {
    function d(b) {
      return function (d) {
        ...
        if (n(this))
          for (c = 0; c < e.length; c++) f = e[c], f instanceof Element && y(a, f)
      }
    }
  ...
  function La() {
    ...
    u(Node.prototype, "appendChild", function (b) {
      if (b instanceof DocumentFragment) {
        ...
        b = H.call(this, b);
        if (n(this))
          for (var c = 0; c < d.length; c++) y(a, d[c]);
        return b
      }
      d = n(b);
      c = H.call(this, b);
    ...
    u(Node.prototype, "replaceChild", function (b, d) {
      if (b instanceof DocumentFragment) {
        ...
        b = qa.call(this, b, d);
        if (n(this))
          for (C(a, d), d = 0; d < c.length; d++) y(a, c[d]);
        return b
      }
      c = n(b);
  ...
  function Ma(a) {
    ...
    function c(b) {
      return function (d) {
        ...
        b.apply(this, c);
        for (c = 0; c < h.length; c++) C(a, h[c]);
        if (n(this))
          for (c = 0; c < e.length; c++) h = e[c], h instanceof Element && y(a, h)
      }
    }
    ...
    void 0 !== Ea &&
      u(b, "replaceWith", function (b) {
        ...
        h = n(this);
        Ea.apply(this, d);
        for (d = 0; d < m.length; d++) C(a, m[d]);
        if (h)
          for (C(a, this), d = 0; d < c.length; d++) m = c[d], m instanceof Element && y(a, m)
      });
  ...
  function Na() {
    ...
    O && O.get ? b(Element.prototype, O) : S && S.get ? b(HTMLElement.prototype, S) : da(a, function (a) {
      b(a, {
        ...
        set: function (a) {
          ...
          for (c.innerHTML = a; 0 < d.childNodes.length;) I.call(d, d.childNodes[0]);
          for (a = b ? c.content : c; 0 < a.childNodes.length;) H.call(d,
            a.childNodes[0])
        }
      })
    });
    ...
    u(Element.prototype, "setAttributeNS", function (b, c, f) {
      if (1 !== this.__CE_state) return ua.call(this, b, c, f);
    ...
    u(Element.prototype, "removeAttribute", function (b) {
      if (1 !== this.__CE_state) return ta.call(this,
        b);
      var d = P.call(this, b);
      ta.call(this, b);
